    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading"><center>Class <code>IX-X</code> Result Print Form</center></div>

                <div class="panel-body">
                    <div class="col-md-12">
                    {!! Form::open(['url' => 'result/class-wise-result-show', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form' ]) !!}
