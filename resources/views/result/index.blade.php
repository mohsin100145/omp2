...
<div class="row">
    <div class="col-sm-12">
        <h3 style="margin-top: 0px;">
            ...
            Results List of <mark>Nine</mark> & <mark>Ten</mark>

            <a href="{{ url('result/create') }}" class="btn btn-primary pull-right">
                <i class="fa fa-plus"></i> Create Result for <code><b>Nine</b></code> & <code><b>Ten</b></code>
            </a>
        </h3>
        ...
        <div class="panel panel-danger">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><i class="fa fa-list-ul"></i> Results List <code><b>Nine</b></code> & <code><b>Ten</b></code></h3>
            </div>
